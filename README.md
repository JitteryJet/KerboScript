## KerboScript Repository 👋

This repository is a copy of the Windows folder where I keep all my active KerboScript scripts.
Kerboscript is the scripting language used by the Kerbal Operating System (kOS) autopilot mod.

I share one copy of my KerboScript folder across multiple Kerbal Space Program (KSP) installs
by using Windows junctions - so far no problems with the Windows file system.
